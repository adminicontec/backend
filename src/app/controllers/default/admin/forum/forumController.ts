...
class ForumController {
  ...
  /**
	...
	public delete = async (req: Request, res: Response) => {
		const response = await forumService.delete(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
	...
	public list = async (req: Request, res: Response) => {
		const response = await forumService.list(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
    ...
    const {id} = req.getParameters.all()
		const response = await forumService.findBy({query: QueryValues.ONE, where: [{field: '_id', value: id}]})
		return responseUtility.sendResponseFromObject(res, response)
	}
...
export { ForumController as DefaultAdminForumForumController };
