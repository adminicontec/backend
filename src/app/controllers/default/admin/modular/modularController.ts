...
class ModularController {
  ...
  /**
	...
	public delete = async (req: Request, res: Response) => {
		const response = await modularService.delete(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
	...
	public list = async (req: Request, res: Response) => {
		const response = await modularService.list(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
    ...
    const {id} = req.getParameters.all()
		const response = await modularService.findBy({query: QueryValues.ONE, where: [{field: '_id', value: id}]})
		return responseUtility.sendResponseFromObject(res, response)
	}
}

export const modularController = new ModularController();
export { ModularController as DefaultAdminModularModularController };
