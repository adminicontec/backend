...
class RegionalController {
  ...
  /**
    ...
    const response = await regionalService.insertOrUpdate(req.getParameters.all())
	...
	public delete = async (req: Request, res: Response) => {
		const response = await regionalService.delete(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
	...
	public list = async (req: Request, res: Response) => {
		const response = await regionalService.list(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
    ...
    const {id} = req.getParameters.all()
		const response = await regionalService.findBy({query: QueryValues.ONE, where: [{field: '_id', value: id}]})
		return responseUtility.sendResponseFromObject(res, response)
	}
...
export { RegionalController as DefaultAdminRegionalRegionalController };
