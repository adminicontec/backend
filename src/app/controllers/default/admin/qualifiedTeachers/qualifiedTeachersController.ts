...
class QualifiedTeachersController {
 ...
 */
     public create = async (req: Request, res: Response) => {
      const response = await qualifiedTeachersService.insertOrUpdate(req.getParameters.all())
   ...
   */
    ...
    public delete = async (req: Request, res: Response) => {
      const response = await qualifiedTeachersService.delete(req.getParameters.all())
      return responseUtility.sendResponseFromObject(res, response)
    }
   ...
   */
    public get = async (req: Request, res: Response) => {
      ...
      const response = await qualifiedTeachersService.findBy({ query: QueryValues.ONE, where: [{ field: '_id', value: id }] })
      return responseUtility.sendResponseFromObject(res, response)
    }
...
export { QualifiedTeachersController as DefaultAdminQualifiedTeachersQualifiedTeachersController };
