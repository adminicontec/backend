...
class CompanyController {
  ...
  /**
    ...
    const response = await companyService.insertOrUpdate(params)
	...
	public delete = async (req: Request, res: Response) => {
		const response = await companyService.delete(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
	...
	public list = async (req: Request, res: Response) => {
		const response = await companyService.list(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
    ...
    const {id} = req.getParameters.all()
		const response = await companyService.findBy({query: QueryValues.ONE, where: [{field: '_id', value: id}]})
		return responseUtility.sendResponseFromObject(res, response)
	}
...
export { CompanyController as DefaultAdminCompanyCompanyController };
