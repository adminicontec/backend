...
class CountryController {
  ...
  /**
    ...
    const response = await countryService.insertOrUpdate(req.getParameters.all())
	...
	public delete = async (req: Request, res: Response) => {
		const response = await countryService.delete(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
	...
	public list = async (req: Request, res: Response) => {
		const response = await countryService.list(req.getParameters.all())
		return responseUtility.sendResponseFromObject(res, response)
  }
    ...
    const {id} = req.getParameters.all()
		const response = await countryService.findBy({query: QueryValues.ONE, where: [{field: '_id', value: id}]})
		return responseUtility.sendResponseFromObject(res, response)
	}
...
export { CountryController as DefaultAdminCountryCountryController };
