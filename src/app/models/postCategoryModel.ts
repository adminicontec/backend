...
const PostCategorySchema = new Schema({
  ...
  collection: 'post_categories' ,timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' }
});
...
// PostCategorySchema.methods.invalid_fields = ["field1", "field2"];

// INFO: Si desea implementar un metodo despues de guardar habilite el siguiente metodo
// PostCategorySchema.methods.postSave = (parameters) => {
// }
