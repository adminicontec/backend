...
const CountrySchema = new Schema({
  ...
  collection: 'countries' ,timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' }
});
...
// CountrySchema.methods.invalid_fields = ["field1", "field2"];

// INFO: Si desea implementar un metodo despues de guardar habilite el siguiente metodo
// CountrySchema.methods.postSave = (parameters) => {
// }
