...
const SurveySchema = new Schema({
  ...
  collection: 'surveys' ,timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' }
});
...
SurveySchema.plugin(mongoose_delete,{
  deletedAt : true,
  overrideMethods: 'all',
  indexFields: 'all'
});
...
// SurveySchema.methods.invalid_fields = ["field1", "field2"];

// INFO: Si desea implementar un metodo despues de guardar habilite el siguiente metodo
// SurveySchema.methods.postSave = (parameters) => {
// }


export const SurveyModel = mongoose.model<any, any>('Survey', SurveySchema);
