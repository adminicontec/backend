...
const LikeSchema = new Schema({
  ...
  collection: 'likes' ,timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' }
});
...
// LikeSchema.methods.invalid_fields = ["field1", "field2"];

// INFO: Si desea implementar un metodo despues de guardar habilite el siguiente metodo
// LikeSchema.methods.postSave = (parameters) => {
// }


export const LikeModel = mongoose.model<any, any>('Like', LikeSchema);
