...
const CitySchema = new Schema({
  ...
  collection: 'cities' ,timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' }
});
...
// CitySchema.methods.invalid_fields = ["field1", "field2"];

// INFO: Si desea implementar un metodo despues de guardar habilite el siguiente metodo
// CitySchema.methods.postSave = (parameters) => {
// }


export const CityModel = mongoose.model<any, any>('City', CitySchema);
