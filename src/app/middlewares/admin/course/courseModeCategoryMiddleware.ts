...
class CourseModeCategoryMiddleware {
...
export const courseModeCategoryMiddleware = new CourseModeCategoryMiddleware();
export { CourseModeCategoryMiddleware as AdminCourseCourseModeCategoryMiddleware }
