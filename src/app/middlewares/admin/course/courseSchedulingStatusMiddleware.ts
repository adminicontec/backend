...
class CourseSchedulingStatusMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
      ...
      { key: 'description', label: 'Descripción del estado'},
		];
...
export const courseSchedulingStatusMiddleware = new CourseSchedulingStatusMiddleware();
export { CourseSchedulingStatusMiddleware as AdminCourseCourseSchedulingStatusMiddleware }
