...
class CourseSchedulingModeMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre del modo'},
      { key: 'description', label: 'Descripción del modo'},
		];
...
export const courseSchedulingModeMiddleware = new CourseSchedulingModeMiddleware();
export { CourseSchedulingModeMiddleware as AdminCourseCourseSchedulingModeMiddleware }
