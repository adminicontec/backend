...
class RegionalMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre de la regional'}
		];
...
export const regionalMiddleware = new RegionalMiddleware();
export { RegionalMiddleware as AdminRegionalRegionalMiddleware }
