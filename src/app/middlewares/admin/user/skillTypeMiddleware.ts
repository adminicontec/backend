...
class SkillTypeMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre de la habilidad'},
		];
...
export const skillTypeMiddleware = new SkillTypeMiddleware();
export { SkillTypeMiddleware as AdminUserSkillTypeMiddleware }
