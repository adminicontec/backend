...
class CertificateCriteriaByModalityMiddleware {
...
export const certificateCriteriaByModalityMiddleware = new CertificateCriteriaByModalityMiddleware();
export { CertificateCriteriaByModalityMiddleware as AdminCertificateCertificateCriteriaByModalityMiddleware }
