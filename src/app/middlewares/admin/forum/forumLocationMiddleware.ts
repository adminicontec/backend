...
class ForumLocationMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre de la ubicación'}
		];
...
export const forumLocationMiddleware = new ForumLocationMiddleware();
export { ForumLocationMiddleware as AdminForumForumLocationMiddleware }
