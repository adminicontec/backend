...
class EnvironmentMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre del entorno'},
		];
...
export const environmentMiddleware = new EnvironmentMiddleware();
export { EnvironmentMiddleware as AdminSecureEnvironmentEnvironmentMiddleware }
