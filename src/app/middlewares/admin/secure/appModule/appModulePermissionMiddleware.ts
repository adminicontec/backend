...
class AppModulePermissionMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre del permiso'},
		];
...
export const appModulePermissionMiddleware = new AppModulePermissionMiddleware();
export { AppModulePermissionMiddleware as AdminSecureAppModuleAppModulePermissionMiddleware }
