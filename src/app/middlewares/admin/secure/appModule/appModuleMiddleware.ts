...
class AppModuleMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config: ValidatorRequest[] = [
      { key: 'name', label: 'Nombre del modulo'},
		];
...
export const appModuleMiddleware = new AppModuleMiddleware();
export { AppModuleMiddleware as AdminSecureAppModuleAppModuleMiddleware }
