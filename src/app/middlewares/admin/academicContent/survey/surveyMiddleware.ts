...
class SurveyMiddleware {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
		...
		const fields_config = [
			{ key: 'name', label: 'Nombre de la encuesta' }
		];

		await requestUtility.middlewareValidator(fields_config, req, res, next)
  }

  public createGhost = async (req: Request, res: Response, next: NextFunction) => {
...
export const surveyMiddleware = new SurveyMiddleware();
export { SurveyMiddleware as AdminAcademicContentSurveySurveyMiddleware }
