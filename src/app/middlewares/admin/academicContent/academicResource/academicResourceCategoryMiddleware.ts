...
class AcademicResourceCategoryMiddleware {
...
export const academicResourceCategoryMiddleware = new AcademicResourceCategoryMiddleware();
export { AcademicResourceCategoryMiddleware as AdminAcademicContentAcademicResourceAcademicResourceCategoryMiddleware }
