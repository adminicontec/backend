...
class QuestionCategoryMiddleware {
...
export const questionCategoryMiddleware = new QuestionCategoryMiddleware();
export { QuestionCategoryMiddleware as AdminAcademicContentQuestionsQuestionCategoryMiddleware }
