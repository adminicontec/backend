...
class CourseSchedulingDataMiddleware {
...
export const courseSchedulingDataMiddleware = new CourseSchedulingDataMiddleware();
export { CourseSchedulingDataMiddleware as DataCourseCourseSchedulingDataMiddleware }
