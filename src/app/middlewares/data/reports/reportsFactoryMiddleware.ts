...
class ReportsFactoryMiddleware {
...
export const reportsFactoryMiddleware = new ReportsFactoryMiddleware();
export { ReportsFactoryMiddleware as DataReportsReportsFactoryMiddleware }
