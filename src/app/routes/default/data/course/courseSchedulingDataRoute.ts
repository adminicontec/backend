...
import { DefaultDataCourseCourseSchedulingDataController as Controller } from "@scnode_app/controllers/default/data/course/courseSchedulingDataController";
// @end
...
class CourseSchedulingDataRoute {

  private router_prefix: string = '/data/course-scheduling'; //Ej: /user
...
export const courseSchedulingDataRoute = new CourseSchedulingDataRoute();
export { CourseSchedulingDataRoute as DefaultDataCourseCourseSchedulingDataRoute };
