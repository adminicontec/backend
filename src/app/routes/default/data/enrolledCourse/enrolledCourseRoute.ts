...
import { DefaultDataEnrolledCourseEnrolledCourseController as Controller } from "@scnode_app/controllers/default/data/enrolledCourse/enrolledCourseController";
// @end
...
class EnrolledCourseRoute {

  private router_prefix: string = '/data/enrolledCourse'; //Ej: /user
...
export const enrolledCourseRoute = new EnrolledCourseRoute();
export { EnrolledCourseRoute as DefaultDataEnrolledCourseEnrolledCourseRoute };
