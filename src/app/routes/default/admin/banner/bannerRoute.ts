...
import { DefaultAdminBannerBannerController as Controller } from "@scnode_app/controllers/default/admin/banner/bannerController";
// @end
...
class BannerRoute {
  ...
  private router_prefix: string = '/admin/banner'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'banner', method: 'create', dir: 'admin/banner' }], ['auth'])
...
export const bannerRoute = new BannerRoute();
export { BannerRoute as DefaultAdminBannerBannerRoute };
