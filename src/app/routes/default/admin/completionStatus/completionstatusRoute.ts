...
import { DefaultAdminCompletionStatusCompletionstatusController as Controller } from "@scnode_app/controllers/default/admin/completionStatus/completionstatusController";
// @end
...
class CompletionstatusRoute {

  private router_prefix: string = '/completionstatus'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/summary', this.instanceController.activitiesSummary, [], ['auth'])
    // @end
  }
}

export const completionstatusRoute = new CompletionstatusRoute();
export { CompletionstatusRoute as DefaultAdminCompletionStatusCompletionstatusRoute };
