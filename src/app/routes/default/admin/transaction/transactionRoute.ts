...
import { DefaultAdminTransactionTransactionController as Controller } from "@scnode_app/controllers/default/admin/transaction/transactionController";
// @end
...
export const transactionRoute = new TransactionRoute();
export { TransactionRoute as DefaultAdminTransactionTransactionRoute };
