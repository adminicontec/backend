...
import { DefaultAdminCertificateQueueCertificateLogsController as Controller } from "@scnode_app/controllers/default/admin/certificateQueue/certificateLogsController";
// @end
...
class CertificateLogsRoute {

  private router_prefix: string = '/admin/logs/certificate'; //Ej: /user
...
export const certificateLogsRoute = new CertificateLogsRoute();
export { CertificateLogsRoute as DefaultAdminCertificateQueueCertificateLogsRoute };
