...
import { DefaultAdminCityCityController as Controller } from "@scnode_app/controllers/default/admin/city/cityController";
// @end
...
class CityRoute {
  ...
  private router_prefix: string = '/admin/city'; //Ej: /user
...
export const cityRoute = new CityRoute();
export { CityRoute as DefaultAdminCityCityRoute };
