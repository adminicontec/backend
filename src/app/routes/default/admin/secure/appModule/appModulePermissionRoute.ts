...
class AppModulePermissionRoute {

  private router_prefix: string = '/admin/secure/app-module/permission'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'app-module-permission', method: 'create', dir: 'admin/secure/appModule' }], ['auth'])
...
export const appModulePermissionRoute = new AppModulePermissionRoute();
export { AppModulePermissionRoute as DefaultAdminSecureAppModuleAppModulePermissionRoute };
