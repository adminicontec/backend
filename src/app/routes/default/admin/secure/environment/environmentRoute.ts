...
import { DefaultAdminSecureEnvironmentEnvironmentController as Controller } from "@scnode_app/controllers/default/admin/secure/environment/environmentController";
// @end
...
class EnvironmentRoute {
  ...
  private router_prefix: string = '/admin/secure/environment'; //Ej: /user
...
export const environmentRoute = new EnvironmentRoute();
export { EnvironmentRoute as DefaultAdminSecureEnvironmentEnvironmentRoute };
