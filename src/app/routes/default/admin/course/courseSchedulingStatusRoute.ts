...
import { DefaultAdminCourseCourseSchedulingStatusController as Controller } from "@scnode_app/controllers/default/admin/course/courseSchedulingStatusController";
// @end
...
class CourseSchedulingStatusRoute {

  private router_prefix: string = '/admin/course-scheduling-status'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'course-scheduling-status', method: 'create', dir: 'admin/course' }], ['auth'])
...
export const courseSchedulingStatusRoute = new CourseSchedulingStatusRoute();
export { CourseSchedulingStatusRoute as DefaultAdminCourseCourseSchedulingStatusRoute };
