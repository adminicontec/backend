...
import { DefaultAdminCourseCourseContentController as Controller } from "@scnode_app/controllers/default/admin/course/courseContentController";
// @end
...
class CourseContentRoute {
  ...
  private router_prefix: string = '/admin/coursecontent'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/modules', this.instanceController.moduleList, [], ['auth'])
    // @end
  }
}

export const courseContentRoute = new CourseContentRoute();
export { CourseContentRoute as DefaultAdminCourseCourseContentRoute };
