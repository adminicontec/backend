...
import { DefaultAdminCourseCourseSchedulingTypeController as Controller } from "@scnode_app/controllers/default/admin/course/courseSchedulingTypeController";
// @end
...
class CourseSchedulingTypeRoute {

  private router_prefix: string = '/admin/course-scheduling-type'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'course-scheduling-type', method: 'create', dir: 'admin/course' }], ['auth'])
...
export const courseSchedulingTypeRoute = new CourseSchedulingTypeRoute();
export { CourseSchedulingTypeRoute as DefaultAdminCourseCourseSchedulingTypeRoute };
