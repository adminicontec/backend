...
import { DefaultAdminCourseCourseSchedulingSectionController as Controller } from "@scnode_app/controllers/default/admin/course/courseSchedulingSectionController";
// @end
...
class CourseSchedulingSectionRoute {

  private router_prefix: string = '/admin/course-scheduling-section'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'course-scheduling-section', method: 'create', dir: 'admin/course' }], ['auth'])
...
export const courseSchedulingSectionRoute = new CourseSchedulingSectionRoute();
export { CourseSchedulingSectionRoute as DefaultAdminCourseCourseSchedulingSectionRoute };
