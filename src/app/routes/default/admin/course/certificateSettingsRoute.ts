...
import { DefaultAdminCourseCertificateSettingsController as Controller } from "@scnode_app/controllers/default/admin/course/certificateSettingsController";
// @end
...
class CertificateSettingsRoute {

  private router_prefix: string = '/admin/certificate-settings'; //Ej: /user
...
export const certificateSettingsRoute = new CertificateSettingsRoute();
export { CertificateSettingsRoute as DefaultAdminCourseCertificateSettingsRoute };
