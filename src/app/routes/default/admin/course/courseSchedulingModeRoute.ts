...
import { DefaultAdminCourseCourseSchedulingModeController as Controller } from "@scnode_app/controllers/default/admin/course/courseSchedulingModeController";
// @end
...
class CourseSchedulingModeRoute {

  private router_prefix: string = '/admin/course-scheduling-mode'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'course-scheduling-mode', method: 'create', dir: 'admin/course' }], ['auth'])
...
export const courseSchedulingModeRoute = new CourseSchedulingModeRoute();
export { CourseSchedulingModeRoute as DefaultAdminCourseCourseSchedulingModeRoute };
