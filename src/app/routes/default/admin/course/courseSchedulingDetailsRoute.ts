...
import { DefaultAdminCourseCourseSchedulingDetailsController as Controller } from "@scnode_app/controllers/default/admin/course/courseSchedulingDetailsController";
// @end
...
class CourseSchedulingDetailsRoute {

  private router_prefix: string = '/admin/course-scheduling-details'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'course-scheduling-details', method: 'create', dir: 'admin/course' }], ['auth'])
...
export const courseSchedulingDetailsRoute = new CourseSchedulingDetailsRoute();
export { CourseSchedulingDetailsRoute as DefaultAdminCourseCourseSchedulingDetailsRoute };
