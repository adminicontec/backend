...
import { DefaultAdminCourseMasterCategoryController as Controller } from "@scnode_app/controllers/default/admin/course/masterCategoryController";
// @end
...
export const masterCategoryRoute = new MasterCategoryRoute();
export { MasterCategoryRoute as DefaultAdminCourseMasterCategoryRoute };
