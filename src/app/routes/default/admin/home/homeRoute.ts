...
import { DefaultAdminHomeHomeController as Controller } from "@scnode_app/controllers/default/admin/home/homeController";
// @end
...
class HomeRoute {
  ...
  private router_prefix: string = '/admin/home'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'home', method: 'create', dir: 'admin/home' }], ['auth'])
...
export { HomeRoute as DefaultAdminHomeHomeRoute };
