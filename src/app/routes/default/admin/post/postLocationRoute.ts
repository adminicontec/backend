...
import { DefaultAdminPostPostLocationController as Controller } from "@scnode_app/controllers/default/admin/post/postLocationController";
// @end
...
class PostLocationRoute {
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'post-location', method: 'create', dir: 'admin/post' }], ['auth'])
