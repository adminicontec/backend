...
class PostRoute {
  ...
  private router_prefix: string = '/admin/post/post'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'post', method: 'create', dir: 'admin/post' }], ['auth'])
...
export const postRoute = new PostRoute();
export { PostRoute as DefaultAdminPostPostRoute };
