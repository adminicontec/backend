...
import { DefaultAdminPostPostTypeController as Controller } from "@scnode_app/controllers/default/admin/post/postTypeController.ts";
// @end
...
class PostTypeRoute {
  ...
  private router_prefix: string = '/admin/post/type'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'post-type', method: 'create', dir: 'admin/post' }], ['auth'])
...
export const postTypeRoute = new PostTypeRoute();
export { PostTypeRoute as DefaultAdminPostPostTypeRoute };
