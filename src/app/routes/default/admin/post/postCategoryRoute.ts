...
import { DefaultAdminPostPostCategoryController as Controller } from "@scnode_app/controllers/default/admin/post/postCategoryController.ts";
// @end
...
class PostCategoryRoute {

  private router_prefix: string = '/admin/post/category'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'post-category', method: 'create', dir: 'admin/post' }], ['auth'])
...
export const postCategoryRoute = new PostCategoryRoute();
export { PostCategoryRoute as DefaultAdminPostPostCategoryRoute };
