...
import { DefaultAdminQualifiedTeachersQualifiedTeachersController as Controller } from "@scnode_app/controllers/default/admin/qualifiedTeachers/qualifiedTeachersController";
// @end
...
class QualifiedTeachersRoute {

  private router_prefix: string = '/admin/qualifiedTeacher'; //Ej: /user
...
export const qualifiedTeachersRoute = new QualifiedTeachersRoute();
export { QualifiedTeachersRoute as DefaultAdminQualifiedTeachersQualifiedTeachersRoute };
