...
import { DefaultAdminPortfolioPortfolioProgramController as Controller } from "@scnode_app/controllers/default/admin/portfolio/portfolioProgramController";
// @end
...
class PortfolioProgramRoute {

  private router_prefix: string = '/admin/portfolio-program'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [], ['auth'])
		...
		routerUtility.post(app, _route, '/upload-file', this.instanceController.uploadFile, [], ['auth'])
...
export const portfolioProgramRoute = new PortfolioProgramRoute();
export { PortfolioProgramRoute as DefaultAdminPortfolioPortfolioProgramRoute };
