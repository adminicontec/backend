...
import { DefaultAdminModularModularController as Controller } from "@scnode_app/controllers/default/admin/modular/modularController";
// @end
...
class ModularRoute {
  ...
  private router_prefix: string = '/admin/modular'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'modular', method: 'create', dir: 'admin/modular' }], ['auth'])
...
export const modularRoute = new ModularRoute();
export { ModularRoute as DefaultAdminModularModularRoute };
