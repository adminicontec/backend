...
import { DefaultAdminAttachedAttachedController as Controller } from "@scnode_app/controllers/default/admin/attached/attachedController";
// @end
...
class AttachedRoute {
  ...
  private router_prefix: string = '/admin/attached'; //Ej: /user
...
export const attachedRoute = new AttachedRoute();
export { AttachedRoute as DefaultAdminAttachedAttachedRoute };
