...
import { DefaultAdminAttachedCategoryAttachedCategoryController as Controller } from "@scnode_app/controllers/default/admin/attachedCategory/attachedCategoryController";
// @end
...
class AttachedCategoryRoute {

  private router_prefix: string = '/admin/attached-category'; //Ej: /user
...
export const attachedCategoryRoute = new AttachedCategoryRoute();
export { AttachedCategoryRoute as DefaultAdminAttachedCategoryAttachedCategoryRoute };
