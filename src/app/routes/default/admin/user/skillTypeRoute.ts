...
class SkillTypeRoute {

  private router_prefix: string = '/skilltype'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'skill-type', method: 'create', dir: 'admin/user' }], ['auth'])
...
export const skillTypeRoute = new SkillTypeRoute();
export { SkillTypeRoute as DefaultAdminUserSkillTypeRoute };
