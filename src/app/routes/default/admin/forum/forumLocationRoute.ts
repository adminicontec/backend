...
class ForumLocationRoute {

  private router_prefix: string = '/admin/forum/location'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'forum-location', method: 'create', dir: 'admin/forum' }], ['auth'])
...
export const forumLocationRoute = new ForumLocationRoute();
export { ForumLocationRoute as DefaultAdminForumForumLocationRoute };
