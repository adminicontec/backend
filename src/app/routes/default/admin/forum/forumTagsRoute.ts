...
import { DefaultAdminForumForumTagsController as Controller } from "@scnode_app/controllers/default/admin/forum/forumTagsController";
// @end
...
class ForumTagsRoute {

  private router_prefix: string = '/admin/forum/tags'; //Ej: /user
...
export const forumTagsRoute = new ForumTagsRoute();
export { ForumTagsRoute as DefaultAdminForumForumTagsRoute };
