...
import { DefaultAdminForumForumCategoryController as Controller } from "@scnode_app/controllers/default/admin/forum/forumCategoryController.ts";
// @end
...
class ForumCategoryRoute {

  private router_prefix: string = '/admin/forum/category'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.post(app, _route, '/create', this.instanceController.create, [{ middleware: 'forum-category', method: 'create', dir: 'admin/forum' }], ['auth'])
...
export const forumCategoryRoute = new ForumCategoryRoute();
export { ForumCategoryRoute as DefaultAdminForumForumCategoryRoute };
