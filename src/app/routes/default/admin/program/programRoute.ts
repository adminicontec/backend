...
import { DefaultAdminProgramProgramController as Controller } from "@scnode_app/controllers/default/admin/program/programController";
// @end
...
class ProgramRoute {
  ...
  private router_prefix: string = '/admin/program'; //Ej: /user
...
export const programRoute = new ProgramRoute();
export { ProgramRoute as DefaultAdminProgramProgramRoute };
