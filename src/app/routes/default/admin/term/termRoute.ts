...
import { DefaultAdminTermTermController as Controller } from "@scnode_app/controllers/default/admin/term/termController";
// @end
...
class TermRoute {
  ...
  private router_prefix: string = '/admin/term'; //Ej: /user
  ...
  */
  public routes(app,prefix: string = '/'): void {
    ...
    routerUtility.get(app, _route, '/get-by-type/:type', this.instanceController.list, [], [])
...
export const termRoute = new TermRoute();
export { TermRoute as DefaultAdminTermTermRoute };
