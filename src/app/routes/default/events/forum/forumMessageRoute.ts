...
class ForumMessageRoute {

  private router_prefix: string = '/events/forum/:forum'; //Ej: /user
...
export const forumMessageRoute = new ForumMessageRoute();
export { ForumMessageRoute as DefaultEventsForumForumMessageRoute };
