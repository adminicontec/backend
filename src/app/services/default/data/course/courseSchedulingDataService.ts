    ...
    try {
      ...
      return responseUtility.buildResponseSuccess('json', null, {additional_parameters: {
        program: {
          ...
          technical_guideline: (register.technical_guideline) ? (register.technical_guideline) : ''
        },
        courses,
        scheduling,
      }})
