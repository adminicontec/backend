  ...
  public configDb = async (connection_data: MongoConnectionData) => {
    ...
    if (connection_data.hasOwnProperty('host') && connection_data.hasOwnProperty('dbname')) {
      try {
        ...
        const mongoUrl = `mongodb+srv://mongodbicontec:GaLD8hHJymfKdiktoT9u@adminmongodbicontec.mongocluster.cosmos.azure.com/campusicontec?tls=true&authMechanism=SCRAM-SHA-256&retryWrites=false&maxIdleTimeMS=120000`
