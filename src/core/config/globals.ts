...
export const mailer: any = (env.hasOwnProperty('mailer')) ? env['mailer'] : {};
...
export const program_type_collection = [
  { abbr: 'DI', name: 'diplomado' },
  { abbr: 'DA', name: 'diplomado_auditor' },
  { abbr: 'PR', name: 'programa' },
  { abbr: 'PA', name: 'programa_auditor' },
  { abbr: 'CU', name: 'curso' },
  { abbr: 'CA', name: 'curso_auditor' },
  { abbr: 'SE', name: 'sensibilizacion' }
];
export const program_type_abbr = {
  diplomado: 'DI',
  diplomado_auditor: 'DA',
  programa: 'PR',
  programa_auditor: 'PA',
  curso: 'CU',
  curso_auditor: 'CA',
...
export const certificate_template = {
  ...
  parcial: 'CP00000003',
  convenios: 'CP00000004',
  parcial_convenios: 'CP00000005',
